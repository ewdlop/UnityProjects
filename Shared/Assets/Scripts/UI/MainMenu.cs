...
namespace Assets.Scripts.UI
{
    public class MainMenu : MonoBehaviour
    {
        ...
        protected Fading fadeController;

        protected virtual void Start()
        {
            isPaused = false;
            menuStack = new Stack<GameObject>();
            fadeController = FindAnyObjectByType<Fading>();
        }
        ...
        protected IEnumerator ChangeScene(string sceneName)
        {
        ...
        public virtual void ToggleControlMenu(bool boolean)
        {
            if (controlMenu != null)
            {
                if (isInGameMenu)
        ...
        public virtual void ToggleSoundlMenu(bool boolean)
        {
            if (soundMenu != null)
            {
                if (isInGameMenu)
        ...
        public virtual void ToggleCredit(bool boolean)
        {
        ...
        public virtual void ToggleGameModeMenu(bool boolean)
        {
